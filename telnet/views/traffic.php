...
<!--    <li class="cbi-tab"><a href="--><?php //echo $eth0Val  ?><!--">wan1</a></li>-->
...
<embed id="bwsvg" style="width:100%; height:300px; border:1px solid #000000; background-color:#FFFFFF" src="/luci-static/resources/bandwidth.svg" />
