...
<ul class="cbi-tabmenu">
    ...
    <li class="cbi-tab"><a href="<?= $eth0Val?>">wan1</a></li>
...
<!--<embed id="bwsvg" style="width:100%; height:300px; border:1px solid #000000; background-color:#FFFFFF" src="http://--><?//=$eoc_ip?><!--/luci-static/resources/bandwidth.svg" />-->
    ...
    window.setTimeout(
        function() {
            ...
            else
            {
                ...
                // XHR.poll(3, '/cgi-bin/luci/;stok=105c5e205df94c7dfaa1db4590662bc0/admin/status/realtime/bandwidth_status/eth0.491', null,
                //    XHR.poll(3, 'http://<?//=$eoc_ip?>///cgi-bin/luci/;stok=69291ee189f1f7c441f0ab16709b1313/admin/status/realtime', null,
                XHR.poll(3, "<?php echo getPathTo('gettraffic.php')?>", null,
                    function(data, x)
                    {
                        // data = JSON.parse(data);
                        data = JSON.parse(data.responseText);
...
<!--<embed id="bwsvg" style="width:100%; height:300px; border:1px solid #000000; background-color:#FFFFFF" src="http://--><?//=$eoc_ip?><!--/luci-static/resources/bandwidth.svg" />-->
<embed id="bwsvg" style="width:100%; height:300px; border:1px solid #000000; background-color:#FFFFFF" src="<?=getPathTo('bandwidth.svg')?>" />
